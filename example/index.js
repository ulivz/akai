...
const readmeTmpl = fs.readFileSync(path.resolve(__dirname, 'template/README.md'), 'utf-8')

fs.writeFileSync('./README.md', readmi(readmeTmpl, context), 'utf-8')
